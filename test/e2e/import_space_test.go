...
func importOrgSpace(t *testing.T) {
	cwd, err := os.Getwd()
	if err != nil {
	...
	test.RunMigratorCommand(t, "import", "space", test.SpaceName, "--org", test.OrgName, "--export-dir", path.Join(cwd, "export-space-tests"), "--debug")
}
